...
const PAGE_SEO = {
  pt: {
    ...
    ctaDescription: 'Por apenas R$ 5, você cria um tema personalizado com palavras exclusivas e recebe um código para jogar.',
    ...
    faq: [
      ...
      { q: 'Preciso pagar para jogar com os temas?', a: 'Não! Todos os temas listados são 100% gratuitos. Você também pode criar um tema personalizado por R$ 5.' },
  ...
  en: {
    ...
    ctaDescription: 'For only R$ 5, you can create a custom theme with exclusive words and receive a code to play.',
    ...
    faq: [
      ...
      { q: 'Do I need to pay to play with themes?', a: 'No! All listed themes are 100% free. You can also create a custom theme for R$ 5.' },
  ...
  es: {
    ...
    ctaDescription: 'Por solo R$ 5, puedes crear un tema personalizado con palabras exclusivas y recibir un código para jugar.',
    ...
    faq: [
      ...
      { q: '¿Necesito pagar para jugar con los temas?', a: '¡No! Todos los temas listados son 100% gratuitos. También puedes crear un tema personalizado por R$ 5.' },
