...
export default function Doacoes() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="flex-1 flex flex-col items-center justify-center pt-10 md:pt-16 px-4 relative z-20">
        {/* Back button */}
        ...
        <div className="bg-[#242642] rounded-[2rem] md:rounded-[3rem] p-5 md:p-8 shadow-2xl border-4 border-[#2f3252] w-full max-w-3xl animate-fade-in">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1 w-full">
              ...
              <div className="text-center md:text-left mb-4">
                <h1 className="text-2xl md:text-3xl font-black text-white flex items-center justify-center md:justify-start gap-2 mb-1">
              ...
              {payment.status === 'idle' || payment.status === 'loading' || payment.status === 'error' ? (
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col md:flex-row gap-2">
                    <input
                      ...
                      maxLength={50}
                      className="flex-1 px-4 py-3 bg-[#1a2a3a] border-2 border-[#3a5a7a] rounded-xl text-white text-sm placeholder-[#6a8aaa] focus:outline-none focus:border-[#7ec8e3] transition-all"
                    />
                    <input
                      type="text"
                ...
                <div className="space-y-3">
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 flex flex-col md:flex-row items-center gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={resetForm}
                      className="flex-1 px-4 py-3 rounded-xl font-black text-sm flex items-center justify-center gap-2 transition-all border-b-[4px] bg-gradient-to-r from-rose-500 to-pink-500 border-rose-800 text-white hover:brightness-110 active:border-b-0 active:translate-y-1"
                    >
                    ...
                    <Link 
                      href="/" 
                      className="flex-1 px-4 py-3 rounded-xl font-black text-sm flex items-center justify-center gap-2 transition-all border-b-[4px] bg-gradient-to-r from-emerald-500 to-green-500 border-emerald-800 text-white hover:brightness-110 active:border-b-0 active:translate-y-1"
                    >
