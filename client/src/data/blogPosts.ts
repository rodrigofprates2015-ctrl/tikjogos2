...
**Será que você consegue parar exatamente no tempo certo?**`,
    author: { name: 'Equipe TikJogos', role: 'Ciência e diversão', avatar: 'https://picsum.photos/seed/t3mp00/100/100' },
    date: '20 Ago 2026',
    category: 'Tips',
...
export const BLOG_SLUGS: Record<string, { en: string; es: string }> = {
  '17': {
    en: 'timer-game-what-it-reveals-about-time-perception',
    es: 'juego-del-cronometro-que-revela-sobre-la-percepcion-del-tiempo',
  },
  '16': {
