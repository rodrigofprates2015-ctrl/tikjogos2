...
export function GameIdentityLayout({ players, userId, hostId, detail, children, onBackToLobby, onExit, sidebarHeader, sidebarFooter, sidebarClassName, stageClassName }: GameIdentityLayoutProps) {
